package com.xzj.mysql.aspect;

import com.xzj.mysql.annotation.DataSource;
import com.xzj.mysql.config.DynamicDataSourceHolder;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.xzj.mysql.annotation.DataSource)")
